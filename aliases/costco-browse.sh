...
alias costco-browse-cd="cd ~/github-sandbox/costco/browse.costco.web && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
alias costco-digital-forge-cd="cd ~/github-sandbox/costco/forge.digital.components && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
alias costco-public-forge-cd="cd ~/github-sandbox/costco/forge.public.components && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
alias costco-public-forge-lint-cd="cd ~/github-sandbox/costco/forge.public.lint && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
...
alias costco-gdx-forge-digital-cd="cd ~/github-sandbox/costco/gdx-lib-forge-digital-components && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
alias costco-gdx-forge-public-cd="cd ~/github-sandbox/costco/gdx-lib-forge-public-components && nvm use lts/iron && pwd && costco-add-ssh-key && costco-git-config"
