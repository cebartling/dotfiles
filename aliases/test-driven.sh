...
echo "test-driven-angular-example1-cd"
echo "test-driven-svelte-example1-cd"
echo "test-driven-react-example1-cd"
echo "test-driven-storybook-angular-cd"
echo "test-driven-storybook-svelte-cd"
echo "test-driven-dotnet-tdd-example-cd"
echo "---------------------------------------------"
