echo "Configuring saga pattern demo aliases..."
...
echo "-----------------------------------------------"
echo "saga-pattern-cd"
echo "saga-pattern-basic-example-cd"
echo "saga-pattern-basic-example-product-cd"
echo "saga-pattern-basic-example-product-run-tests"
echo "-----------------------------------------------"
